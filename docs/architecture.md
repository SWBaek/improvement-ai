...
1. **Capability source**: `skills/`, `tools/`, `packages/`
2. **Configuration adapters**: `configs/`
3. **Distribution and maintenance**: `scripts/`
4. **Governance**: `AGENTS.md`, `.github/`, `docs/`
5. **Verification**: `tests/`, CI workflow
