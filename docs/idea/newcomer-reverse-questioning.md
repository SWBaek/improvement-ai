...
- Next trigger: WorkOs에서 원장에 없는 새 엔티티가 등장하는 Capture를 모아, 신입 상시 질문과 “없는 잔여만 묻고 한 페이지를 남긴 뒤 신입을 끝내는” 방식을 대조하기 시작할 때 갱신한다.
...
- 원장에 없는 새 엔티티가 등장하는 Capture부터, 없는 잔여만 묻고 한 페이지를 남기는지 본다.
