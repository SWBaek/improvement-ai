...
| [Evidence-Grounded AGENTS.md Evolution](evidence-grounded-agents-md-evolution.md) | `Exploring` | 2026-08-25 | 동일한 read-only 감사 절차를 성숙도가 다른 두 실제 저장소에 적용하고 발견사항의 채택·기각 사유와 최종 목적지를 비교할 때 갱신 |
