...
| [Evidence-Grounded AGENTS.md Evolution](evidence-grounded-agents-md-evolution.md) | `Exploring` | 2026-08-25 | `manage-workspace-agents-md`의 고정 revision으로 성숙도가 다른 두 실제 저장소의 read-only 감사를 시작하고 발견사항의 채택·기각 사유와 최종 목적지를 비교할 때 갱신 |
